...
![流程图：'开始diff'、'直接返回旧节点'、'updateChildren'|w-full|max-w-4xl|shadow-lg](/diagrams/vue2-diff-algorithm-00.svg)
...
![流程图：比较两个节点、直接替换节点、B|w-full|lg:w-3/4](/diagrams/vue2-diff-algorithm-01.svg)
...
![流程图：双端比较算法流程 - 这是一个复杂的算法流程图|w-full|max-w-5xl|border|shadow-lg|bg-white|p-4](/diagrams/vue2-diff-algorithm-02.svg)
...
![流程图：A key=a、B key=b、C key=c|w-full](/diagrams/vue2-diff-algorithm-03.svg)
...
![流程图：D key=d|w-full|lg:w-1/2](/diagrams/vue2-diff-algorithm-04.svg)
...
![流程图：A key=a|w-full|lg:w-1/3](/diagrams/vue2-diff-algorithm-05.svg)
...
![流程图：B key=b|w-full|lg:w-1/2](/diagrams/vue2-diff-algorithm-06.svg)
...
![流程图：C key=c|w-64](/diagrams/vue2-diff-algorithm-07.svg)
...
![流程图：D|w-32](/diagrams/vue2-diff-algorithm-08.svg)
...
![流程图：Diff算法复杂度|w-full|max-w-3xl](/diagrams/vue2-diff-algorithm-09.svg)
