...
![Diff算法整体流程](/images/vue2-diff-algorithm/image1.svg)


## 节点比较策略

<div className="flex justify-center">
  <img src="/images/vue2-diff-algorithm/image2.svg" alt="Diff算法整体流程" className="w-1/2" />
</div>
...
![Diff算法整体流程](/images/vue2-diff-algorithm/image3.svg)
